...
public class UserController {
	...
	public String getUser(String email) throws UserDAOException {
		// this method is used to get the user from the database and return it as a json
		// object.
		// if somewhere in the process an exception is thrown, we catch it and return
		// the message of the exception.
		// the exception will be caught in the server class and the message will be sent
		// to the client.
